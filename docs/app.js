...
const LAT = {
    ...
    ambientmeta: { p50_ms: 29.5, p95_ms: 48.2, p99_ms: 63.8, total_docs: 1113, total_seconds: 295.3, throughput_docs_per_sec: 3.8 },
};
...
const FALLBACK_DATA = {
    adapters: {
        ...
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.8381, per_type: {"PERSON":{"f1":0.8645},"CREDIT_CARD":{"f1":0.9844},"LOCATION":{"f1":0.777},"EMAIL":{"f1":0.9304},"ORGANIZATION":{"f1":0.6941},"SSN":{"f1":0.8873},"PHONE":{"f1":0.8106},"MRN":{"f1":0.9091},"NPI":{"f1":0.9565}} }, categories: { standard: { metrics: { f1: 0.849 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.809 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.799 }, css: { css: 0.685 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.858 }, latency: LAT.ambientmeta } } },
    }
};
