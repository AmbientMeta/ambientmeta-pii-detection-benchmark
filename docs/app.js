...
const FALLBACK_DATA = {
    adapters: {
        regex:       { name: 'Regex Only',                aggregate: { f1: 0.287, per_type: {"PERSON":{"f1":0.0},"CREDIT_CARD":{"f1":0.843},"LOCATION":{"f1":0.0},"EMAIL":{"f1":0.9498},"SSN":{"f1":0.7597},"PHONE":{"f1":0.5552},"MRN":{"f1":0.0},"ORGANIZATION":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.418 }, latency: LAT.regex }, ambiguous: { metrics: { f1: 0.068 }, latency: LAT.regex }, contextual: { metrics: { f1: 0.057 }, css: { css: 0.030 }, latency: LAT.regex }, adversarial: { metrics: { f1: 0.285 }, latency: LAT.regex } } },
        spacy:       { name: 'spaCy NER',                 aggregate: { f1: 0.300, per_type: {"PERSON":{"f1":0.5938},"CREDIT_CARD":{"f1":0.0},"LOCATION":{"f1":0.3099},"EMAIL":{"f1":0.0},"ORGANIZATION":{"f1":0.1284},"SSN":{"f1":0.0},"PHONE":{"f1":0.0},"MRN":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.213 }, latency: LAT.spacy }, ambiguous: { metrics: { f1: 0.372 }, latency: LAT.spacy }, contextual: { metrics: { f1: 0.227 }, css: { css: 0.405 }, latency: LAT.spacy }, adversarial: { metrics: { f1: 0.373 }, latency: LAT.spacy } } },
        presidio:    { name: 'Microsoft Presidio',        aggregate: { f1: 0.477, per_type: {"PERSON":{"f1":0.5938},"CREDIT_CARD":{"f1":0.9065},"LOCATION":{"f1":0.3099},"EMAIL":{"f1":0.9821},"SSN":{"f1":0.6404},"PHONE":{"f1":0.5404},"MRN":{"f1":0.0},"ORGANIZATION":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.549 }, latency: LAT.presidio }, ambiguous: { metrics: { f1: 0.397 }, latency: LAT.presidio }, contextual: { metrics: { f1: 0.266 }, css: { css: 0.370 }, latency: LAT.presidio }, adversarial: { metrics: { f1: 0.523 }, latency: LAT.presidio } } },
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.526, per_type: {"PERSON":{"f1":0.6073},"CREDIT_CARD":{"f1":0.9692},"LOCATION":{"f1":0.3766},"EMAIL":{"f1":0.955},"ORGANIZATION":{"f1":0.1333},"SSN":{"f1":0.8344},"PHONE":{"f1":0.7953},"MRN":{"f1":0.712},"NPI":{"f1":0.8866}} }, categories: { standard: { metrics: { f1: 0.549 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.443 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.288 }, css: { css: 0.505 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.630 }, latency: LAT.ambientmeta } } },
    }
};
