...
const LAT = {
    ...
    ambientmeta: { p50_ms: 28.0, p95_ms: 48.0, p99_ms: 59.8, total_docs: 1113, total_seconds: 339.6, throughput_docs_per_sec: 3.3 },
};
...
const FALLBACK_DATA = {
    adapters: {
        ...
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.6145, per_type: {"PERSON":{"f1":0.6411},"CREDIT_CARD":{"f1":0.9844},"LOCATION":{"f1":0.4059},"EMAIL":{"f1":0.9772},"ORGANIZATION":{"f1":0.2283},"SSN":{"f1":0.8873},"PHONE":{"f1":0.8106},"MRN":{"f1":0.7946},"NPI":{"f1":0.9565}} }, categories: { standard: { metrics: { f1: 0.687 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.533 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.343 }, css: { css: 0.556 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.674 }, latency: LAT.ambientmeta } } },
    }
};
