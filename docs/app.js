...
const LAT = {
    ...
    ambientmeta: { p50_ms: 17.0, p95_ms: 39.1, p99_ms: 54.6, total_docs: 1113, total_seconds: 337.9, throughput_docs_per_sec: 3.3 },
};
...
const FALLBACK_DATA = {
    adapters: {
        ...
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.607, per_type: {"PERSON":{"f1":0.6393},"CREDIT_CARD":{"f1":0.9844},"LOCATION":{"f1":0.4081},"EMAIL":{"f1":0.9772},"ORGANIZATION":{"f1":0.2097},"SSN":{"f1":0.8873},"PHONE":{"f1":0.8106},"MRN":{"f1":0.7946},"NPI":{"f1":0.9565}} }, categories: { standard: { metrics: { f1: 0.683 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.541 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.340 }, css: { css: 0.556 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.655 }, latency: LAT.ambientmeta } } },
    }
};
