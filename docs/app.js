...
const LAT = {
    ...
    ambientmeta: { p50_ms: 14.4, p95_ms: 27.2, p99_ms: 34.6, total_docs: 1113, total_seconds: 241.8, throughput_docs_per_sec: 4.6 },
};
...
const FALLBACK_DATA = {
    adapters: {
        ...
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.7657, per_type: {"PERSON":{"f1":0.7861},"CREDIT_CARD":{"f1":0.9844},"LOCATION":{"f1":0.6357},"EMAIL":{"f1":0.9772},"ORGANIZATION":{"f1":0.544},"SSN":{"f1":0.8873},"PHONE":{"f1":0.8106},"MRN":{"f1":0.8},"NPI":{"f1":0.9565}} }, categories: { standard: { metrics: { f1: 0.812 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.713 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.447 }, css: { css: 0.691 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.852 }, latency: LAT.ambientmeta } } },
    }
};
