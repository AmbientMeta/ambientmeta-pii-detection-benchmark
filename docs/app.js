...
const FALLBACK_DATA = {
    adapters: {
        ...
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.523, per_type: {"PERSON":{"f1":0.6073},"CREDIT_CARD":{"f1":0.8182},"LOCATION":{"f1":0.3766},"EMAIL":{"f1":0.955},"ORGANIZATION":{"f1":0.1333},"SSN":{"f1":0.8344},"PHONE":{"f1":0.7925},"MRN":{"f1":0.712},"NPI":{"f1":0.8866}} }, categories: { standard: { metrics: { f1: 0.540 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.443 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.288 }, css: { css: 0.505 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.630 }, latency: LAT.ambientmeta } } },
    }
};
