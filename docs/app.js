...
const FALLBACK_DATA = {
    adapters: {
        regex:       { name: 'Regex Only',                aggregate: { f1: 0.288, per_type: {"PERSON":{"f1":0.0},"CREDIT_CARD":{"f1":0.8571},"LOCATION":{"f1":0.0},"EMAIL":{"f1":0.963},"SSN":{"f1":0.8099},"PHONE":{"f1":0.5542},"MRN":{"f1":0.0},"ORGANIZATION":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.418 }, latency: LAT.regex }, ambiguous: { metrics: { f1: 0.070 }, latency: LAT.regex }, contextual: { metrics: { f1: 0.057 }, css: { css: 0.030 }, latency: LAT.regex }, adversarial: { metrics: { f1: 0.285 }, latency: LAT.regex } } },
        spacy:       { name: 'spaCy NER',                 aggregate: { f1: 0.326, per_type: {"PERSON":{"f1":0.5938},"CREDIT_CARD":{"f1":0.0},"LOCATION":{"f1":0.3099},"EMAIL":{"f1":0.0},"ORGANIZATION":{"f1":0.1789},"SSN":{"f1":0.0},"PHONE":{"f1":0.0},"MRN":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.284 }, latency: LAT.spacy }, ambiguous: { metrics: { f1: 0.372 }, latency: LAT.spacy }, contextual: { metrics: { f1: 0.228 }, css: { css: 0.405 }, latency: LAT.spacy }, adversarial: { metrics: { f1: 0.373 }, latency: LAT.spacy } } },
        presidio:    { name: 'Microsoft Presidio',        aggregate: { f1: 0.479, per_type: {"PERSON":{"f1":0.5938},"CREDIT_CARD":{"f1":0.9197},"LOCATION":{"f1":0.3099},"EMAIL":{"f1":1.0},"SSN":{"f1":0.6806},"PHONE":{"f1":0.5421},"MRN":{"f1":0.0},"ORGANIZATION":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.549 }, latency: LAT.presidio }, ambiguous: { metrics: { f1: 0.408 }, latency: LAT.presidio }, contextual: { metrics: { f1: 0.267 }, css: { css: 0.370 }, latency: LAT.presidio }, adversarial: { metrics: { f1: 0.523 }, latency: LAT.presidio } } },
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.563, per_type: {"PERSON":{"f1":0.6077},"CREDIT_CARD":{"f1":0.9844},"LOCATION":{"f1":0.3766},"EMAIL":{"f1":0.9725},"SSN":{"f1":0.8873},"PHONE":{"f1":0.8067},"MRN":{"f1":0.7206},"ORGANIZATION":{"f1":0.1806},"NPI":{"f1":0.9565}} }, categories: { standard: { metrics: { f1: 0.657 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.479 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.292 }, css: { css: 0.510 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.630 }, latency: LAT.ambientmeta } } },
    }
};
