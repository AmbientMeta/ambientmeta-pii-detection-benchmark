...
const LAT = {
    regex:       { p50_ms: 0.04, p95_ms: 0.1, p99_ms: 0.1, total_docs: 1188, total_seconds: 0.06, throughput_docs_per_sec: 19800 },
    spacy:       { p50_ms: 6.9, p95_ms: 15.5, p99_ms: 19.1, total_docs: 1188, total_seconds: 9.6, throughput_docs_per_sec: 124 },
    presidio:    { p50_ms: 10.3, p95_ms: 26.9, p99_ms: 32.3, total_docs: 1188, total_seconds: 16.0, throughput_docs_per_sec: 74 },
    ambientmeta: { p50_ms: 26.1, p95_ms: 52.2, p99_ms: 602.3, total_docs: 1188, total_seconds: 339.0, throughput_docs_per_sec: 3.5 },
};

const FALLBACK_DATA = {
    adapters: {
        regex:       { name: 'Regex Only',                aggregate: { f1: 0.290, per_type: {"PERSON":{"f1":0.0},"CREDIT_CARD":{"f1":0.8571},"LOCATION":{"f1":0.0},"EMAIL":{"f1":0.963},"SSN":{"f1":0.8099},"PHONE":{"f1":0.5542},"MRN":{"f1":0.0},"ORGANIZATION":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.418 }, latency: LAT.regex }, ambiguous: { metrics: { f1: 0.070 }, latency: LAT.regex }, contextual: { metrics: { f1: 0.060 }, css: { css: 0.032 }, latency: LAT.regex }, adversarial: { metrics: { f1: 0.285 }, latency: LAT.regex } } },
        spacy:       { name: 'spaCy NER',                 aggregate: { f1: 0.335, per_type: {"PERSON":{"f1":0.6021},"CREDIT_CARD":{"f1":0.0},"LOCATION":{"f1":0.3235},"EMAIL":{"f1":0.0},"ORGANIZATION":{"f1":0.1865},"SSN":{"f1":0.0},"PHONE":{"f1":0.0},"MRN":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.284 }, latency: LAT.spacy }, ambiguous: { metrics: { f1: 0.390 }, latency: LAT.spacy }, contextual: { metrics: { f1: 0.254 }, css: { css: 0.452 }, latency: LAT.spacy }, adversarial: { metrics: { f1: 0.374 }, latency: LAT.spacy } } },
        presidio:    { name: 'Microsoft Presidio',        aggregate: { f1: 0.488, per_type: {"PERSON":{"f1":0.6021},"CREDIT_CARD":{"f1":0.9197},"LOCATION":{"f1":0.3235},"EMAIL":{"f1":1.0},"SSN":{"f1":0.6806},"PHONE":{"f1":0.5421},"MRN":{"f1":0.0},"ORGANIZATION":{"f1":0.0},"NPI":{"f1":0.0}} }, categories: { standard: { metrics: { f1: 0.549 }, latency: LAT.presidio }, ambiguous: { metrics: { f1: 0.426 }, latency: LAT.presidio }, contextual: { metrics: { f1: 0.299 }, css: { css: 0.415 }, latency: LAT.presidio }, adversarial: { metrics: { f1: 0.523 }, latency: LAT.presidio } } },
        ambientmeta: { name: 'AmbientMeta Privacy Guard', aggregate: { f1: 0.584, per_type: {"PERSON":{"f1":0.6236},"CREDIT_CARD":{"f1":0.9844},"LOCATION":{"f1":0.3895},"EMAIL":{"f1":0.9725},"ORGANIZATION":{"f1":0.1997},"SSN":{"f1":0.8873},"PHONE":{"f1":0.8067},"MRN":{"f1":0.7206},"NPI":{"f1":0.9565}} }, categories: { standard: { metrics: { f1: 0.660 }, latency: LAT.ambientmeta }, ambiguous: { metrics: { f1: 0.497 }, latency: LAT.ambientmeta }, contextual: { metrics: { f1: 0.327 }, css: { css: 0.559 }, latency: LAT.ambientmeta }, adversarial: { metrics: { f1: 0.654 }, latency: LAT.ambientmeta } } },
    }
};
